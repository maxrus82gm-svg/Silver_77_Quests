class SplitStoneWithStone_PB extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_split0";
		...
		InsertIngredient(1,"PB_Stone");//you can insert multiple ingredients this way
		
		m_IngredientAddHealth[1] = -8;// 0 = do nothing
