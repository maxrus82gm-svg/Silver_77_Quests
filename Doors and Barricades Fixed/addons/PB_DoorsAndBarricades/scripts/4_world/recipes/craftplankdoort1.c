class CraftPlankDoorT1_PB extends RecipeBase
{
	override void Init()
	{
		m_Name = "#STR_CraftPlankDoorKit";
		...
		//result1
		AddResult("PB_PlankDoor_Kit");//add results here
	...
	{
		if( g_Game.GetPBConfig().Get_CanCraftDoorKits() )
		{
			return true;
		}
		return false;
...
class CraftWoodGateT1_PB extends RecipeBase
{
	override void Init()
	{
		...
		//result1
		AddResult("PB_WoodGate_Kit");//add results here
