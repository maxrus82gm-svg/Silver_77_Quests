class ActionDestroyCombinationLockPBDoorsCB : ActionContinuousBaseCB
{
	int DialLockTime;
...
class ActionDestroyCombinationLockPBDoors: ActionContinuousBase
{	
	void ActionDestroyCombinationLockPBDoors()
	{
		m_CallbackClass = ActionDestroyCombinationLockPBDoorsCB;
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		PBDoorsBase fence = PBDoorsBase.Cast( target_object );
