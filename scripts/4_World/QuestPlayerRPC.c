...
modded class PlayerBase
{
    ...
    private void Silver77_HandleQuestConfigRequest(PlayerIdentity sender)
    {
        ...
        QuestManager.SendConfigToClient(this);
    }
    ...
    private void Silver77_HandleQuestPlayerDataRequest(PlayerIdentity sender)
    {
        ...
        QuestManager.SendPlayerDataToClient(this);
    }
    ...
    private void Silver77_HandleQuestAccept(PlayerIdentity sender, ParamsReadContext ctx)
    {
        ...
        bool accepted = QuestManager.AcceptQuest(this, data.param1, data.param2);
        Print("[Silver_77_Quests] Accept quest RPC result for " + data.param1 + " at trigger " + data.param2 + ": " + accepted);
        QuestManager.SendPlayerDataToClient(this);
    }
    ...
    private void Silver77_HandleQuestComplete(PlayerIdentity sender, ParamsReadContext ctx)
    {
        ...
        bool completed = QuestManager.CompleteQuest(this, data.param1, data.param2);
        Print("[Silver_77_Quests] Complete quest RPC result for " + data.param1 + " at trigger " + data.param2 + ": " + completed);
        QuestManager.SendPlayerDataToClient(this);
    }
    ...
    private void Silver77_HandleQuestConfigData(ParamsReadContext ctx)
    {
        ...
        QuestManager.ApplySyncedConfig(data.param1);
    }
    ...
    private void Silver77_HandleQuestPlayerData(ParamsReadContext ctx)
    {
        ...
        QuestManager.ApplySyncedPlayerData(data.param1);
    }
}
